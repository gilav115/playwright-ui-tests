...
- PlayWright and TypeScript syntax and best practices.
- Debugging.

All code, architecture decisions, and final implementation were reviewed and written by the author. The author fully understands and can explain every part of the solution.
